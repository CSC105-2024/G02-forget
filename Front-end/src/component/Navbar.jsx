...
const Navbar = () => {
  ...
  return (
    <>
    <header className='bg-[#F2F2F2] w-screen -my-16 lg:my-0 drop-shadow-[0_5px_7px_rgba(0,0,0,0.25)]'>
        <nav className='flex justify-between items-center px-2  py-2'>
            ...
            <div className="flex flex-row justify-center items-center w-[100%] lg:hidden"> 
